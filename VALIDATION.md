...
- Hardened Codex review, live: a runner review on a disposable plan completed (`REVISE`, correct) with the connector features disabled. A tool listing under the same flags showed no GitHub tools, but user-configured MCP servers were still present.
